...
import { ProposalAgency, ProposalTheme, FixedCategoryTableData } from '../types';
import { PageHeader } from './PageHeader';
import { PageFooter } from './PageFooter';

interface FixedCategoryTablePageProps {
  pageTitle: string;
  agency: ProposalAgency;
  theme: ProposalTheme;
  data: FixedCategoryTableData;
  pageNumber?: number;
  totalPages?: number;
  footerNumber?: string;
}

export const FixedCategoryTablePage: React.FC<FixedCategoryTablePageProps> = ({
  pageTitle,
  agency,
  theme,
  data,
