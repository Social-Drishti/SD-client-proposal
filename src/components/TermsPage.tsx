      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <div className="space-y-6 text-sm text-slate-700 leading-relaxed mb-10">
          <div>
            ...
            <p className="bg-slate-50 p-4 rounded-lg border border-slate-200/80">
              {legalTerms}
            </p>
          </div>
        ...
        <div className="mt-auto pt-4">
          <h4 className="text-base font-bold text-slate-900 mb-6 border-b border-slate-200 pb-2">
          ...
          <div className="grid grid-cols-2 gap-10">
            ...
            <div className="border border-slate-200 rounded-xl p-5 bg-slate-50/50">
              ...
              <div className="h-10 border-b border-slate-300 border-dashed mb-2 flex items-end pb-1">
              ...
              <p className="text-[11px] font-semibold text-slate-400 mt-2">Date: _______________</p>
            </div>
