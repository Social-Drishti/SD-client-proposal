...
import { ProposalAgency, ProposalTheme, ServiceScopeTableData } from '../types';
import { PageHeader } from './PageHeader';
import { PageFooter } from './PageFooter';

interface ServiceScopeTablePageProps {
  pageTitle: string;
  agency: ProposalAgency;
  theme: ProposalTheme;
  data: ServiceScopeTableData;
  pageNumber?: number;
  totalPages?: number;
  footerNumber?: string;
}

export const ServiceScopeTablePage: React.FC<ServiceScopeTablePageProps> = ({
  pageTitle,
  agency,
  theme,
  data,
