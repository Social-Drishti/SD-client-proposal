...
import { ProposalAgency, ProposalTheme, VideoProductionTableData } from '../types';
import { PageHeader } from './PageHeader';
import { PageFooter } from './PageFooter';

interface VideoProductionTablePageProps {
  pageTitle: string;
  agency: ProposalAgency;
  theme: ProposalTheme;
  data: VideoProductionTableData;
  pageNumber?: number;
  totalPages?: number;
  footerNumber?: string;
}

export const VideoProductionTablePage: React.FC<VideoProductionTablePageProps> = ({
  pageTitle,
  agency,
  theme,
  data,
  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-between bg-white overflow-hidden p-6 sm:p-10 select-none">
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        {/* Table Column Headers — locked structure */}
