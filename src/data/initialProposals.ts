...
export const socialDrishtiProposal: Proposal = {
  ...
  agency: {
    ...
    logoUrl: '/social_drishti_logo.jpg',
    footerLogoUrl: '/social_drishti_footer_logo.png',
    email: 'contact@socialdrishti.com',
    phone: '+91 98765 43210',
    website: 'www.socialdrishti.com',
    address: 'Mumbai / Delhi, India'
  },
  client: {
  ...
  theme: {
    ...
    showWatermark: true,
    watermarkType: 'logo',
    watermarkLogoUrl: '/social_drishti_logo.jpg',
      ...
      tableData: {
        ...
        rows: [
          ...
          },
          {
            id: 'r5',
            category: 'Content',
            details: 'Monthly content calendar planning\nCopywriting and caption writing'
          },
          {
            id: 'r6',
            category: 'Designing',
        ...
        notes: [
          {
            ...
            description: 'If any post requires boosting, it will involve an additional cost, which must be approved and paid by the client in advance.'
          },
          {
            id: 'n2',
            title: 'Extra Designs',
            description: 'Any design work outside the agreed scope (e.g., social media post & banner) will be billed as per standard rate card.'
          }
        ]
      }
    }
        ...
        notes: [
          {
            id: 'wn1',
            title: 'Deposit (30%)',
            description: '$11,550 due upon contract signature to initiate sprint planning.'
          },
          {
            id: 'wn2',
            title: 'Beta Launch (40%)',
            description: '$15,400 due upon completion of staging deployment and user acceptance testing.'
          },
          {
            id: 'wn3',
            title: 'Final Handover (30%)',
            description: '$11,550 due upon production launch and source code repository transfer.'
          }
        ]
      }
    }
